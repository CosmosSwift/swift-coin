...
public final class MutableTree: ImmutableTree {
    // The most recently saved tree.
    // TODO: Find a better way to implement this
    var lastSaved: ImmutableTree!
    // Nodes removed by changes to working tree.
    let orphans: [String: Int64]
    // The previous, saved versions of the tree.
    let versions: [Int64: Bool]
